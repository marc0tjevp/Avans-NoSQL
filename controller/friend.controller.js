...
function addFriend(req, res) {
	...
	neo.createFriendship(res, user1, user2, function() {
		res.status(200).json(new ApiResponse(200, "Friendship added")).end()
	})
}
...
function getAll(req, res) {
	...
	// Get all friends
	neo.getFriendships(res, username, 1, function (friends) {
